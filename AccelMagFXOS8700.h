...
typedef enum
{
    ACCELMAG_REG_STATUS     = 0x00,  //FXOS8700_REGISTER_STATUS          
    ACCELMAG_REG_ID         = 0x0D,  //FXOS8700_REGISTER_WHO_AM_I        
    ACCELMAG_REG_XYZ_CFG    = 0x0E,    //FXOS8700_REGISTER_XYZ_DATA_CFG    
    ...
    ACCELMAG_REG_CTRL1      = 0x2A,  //FXOS8700_REGISTER_CTRL_REG1       
    ACCELMAG_REG_CTRL2      = 0x2B,
    ACCELMAG_REG_CTRL3      = 0x2C,
    ACCELMAG_REG_CTRL4      = 0x2D,
    ACCELMAG_REG_CTRL5      = 0x2E,
    ACCELMAG_REG_MSTATUS    = 0x32,  //FXOS8700_REGISTER_MSTATUS         
    ACCELMAG_REG_MOUT_X_MSB = 0x33,  //FXOS8700_REGISTER_MOUT_X_MSB      
    ...
    ACCELMAG_REG_MCTRL1     = 0x5B,  //FXOS8700_REGISTER_MCTRL_REG1      
